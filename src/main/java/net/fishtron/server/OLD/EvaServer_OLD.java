...
public class EvaServer_OLD extends AbstractHandler {
    ...
    public EvaServer_OLD(JSONObject config) {
    ...
    public void addJobClass(String jobName, Class<? extends EvaJob_OLD> jobClass, Object initData) {
        jobMan.addJobClass(jobName, jobClass, initData);
        Log.it("Added class for job '"+jobName+"'.");
    }

    public void addJobClass(String jobName, Class<? extends EvaJob_OLD> jobClass) {
    ...
    private static void runServer() {
        EvaServer_OLD evaServer = new EvaServer_OLD(defaultConfig);
