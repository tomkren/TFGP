...
xover_file=dir.'/derived/'.xover.'_2-w'.window.'_normalized.txt'
mut_1_file=dir.'/derived/'.mut_1.'_2-w'.window.'_normalized.txt'
mut_2_file=dir.'/derived/'.mut_2.'_2-w'.window.'_normalized.txt'
